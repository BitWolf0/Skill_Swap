...
<div class="main-wrapper">
  <header class="topbar" role="banner">
    ...
    <?php $searchPages = ['marketplace', 'recherche', 'catalogue', 'mes_competences', 'mes_demandes', 'nouvelle_demande']; ?>
    <div class="search-wrap<?= !in_array($currentPage, $searchPages, true) ? ' search-wrap--hidden' : '' ?>">
