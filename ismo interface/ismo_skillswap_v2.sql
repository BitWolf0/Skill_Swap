...
CREATE TABLE mentor_relationships (
    ...
    INDEX idx_mentor_active (mentor_id, relationship_status)
);
...
CREATE TABLE marketplace_interactions (
    ...
    FOREIGN KEY (user_id)    REFERENCES users(user_id)                   ON DELETE CASCADE,
    UNIQUE KEY unique_user_listing_interaction (listing_id, user_id, interaction_type),
...
CREATE TABLE support_tickets (
    ...
    description TEXT NOT NULL,
    category    ENUM('account','technical','billing','report','other') DEFAULT 'other',
