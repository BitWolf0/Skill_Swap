...
if (!$profileUser) redirect('dashboard.php');
        ...
        <div style="background:#fff;padding:1.5rem;border-radius:12px;border:1px solid #e2e8f0;box-shadow:0 1px 2px rgba(0,0,0,0.05);">
          ...
          <div style="display:flex;flex-direction:column;gap:1rem;">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
              <div>
                <span style="font-size:0.75rem;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;">Prénom</span>
                <p style="margin:4px 0 0;font-size:0.95rem;color:#1e293b;"><?= h($profileUser['prenom']) ?></p>
              </div>
              <div>
                <span style="font-size:0.75rem;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;">Nom</span>
                <p style="margin:4px 0 0;font-size:0.95rem;color:#1e293b;"><?= h($profileUser['nom']) ?></p>
              </div>
            </div>
            <?php if ($profileUser['filiere']): ?>
            <div>
              <span style="font-size:0.75rem;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;">Filière</span>
              <p style="margin:4px 0 0;font-size:0.95rem;color:#1e293b;"><?= h($profileUser['filiere']) ?></p>
            </div>
            <?php endif; ?>
            <?php if ($profileUser['bio']): ?>
            <div>
              <span style="font-size:0.75rem;font-weight:600;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;">Bio</span>
              <p style="margin:4px 0 0;font-size:0.95rem;color:#1e293b;line-height:1.5;"><?= nl2br(h($profileUser['bio'])) ?></p>
            </div>
            <?php endif; ?>
            <div style="padding-top:0.75rem;border-top:1px solid #e2e8f0;">
              <span style="display:inline-flex;align-items:center;gap:6px;font-size:0.9rem;color:#475569;">
                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:<?= $profileUser['disponible'] ? '#22c55e' : '#6b7280' ?>;"></span>
                <?= $profileUser['disponible'] ? 'Disponible pour aider' : 'Non disponible' ?>
              </span>
            </div>
          </div>
          <?php endif; ?>
