    ...
    <div class="rank-grid">
      ...
      <div class="rank-card <?= $i < 3 ? 'top top-' . ($i + 1) : '' ?>">
        <div class="rank-card-inner">
          ...
          <a href="<?= $u['role'] === 'mentor' ? '../pages_mentor/profile.php' : '../pages_stagiaire/profile.php' ?>?id=<?= $u['id'] ?>" class="rank-profile-link">Voir le profil <span class="icon-arrow" aria-hidden="true"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></span></a>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
